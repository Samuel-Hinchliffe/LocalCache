...
<div align="center">
  ...
  <p align="center">
    🤖 <a href="https://en.wikipedia.org/wiki/Content-based_image_retrieval#:~:text=%22Content%2Dbased%22%20means%20that,derived%20from%20the%20image%20itself.">This project provides a LocalCache class that allows for storing and retrieving data in the browser's local storage with optional time-to-live (TTL) functionality.</a>
    <br />
